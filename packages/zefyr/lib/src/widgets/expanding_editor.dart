...
import 'package:zefyr/src/widgets/expanding_editable_text.dart';
...
class ZefyrExpandingEditor extends StatefulWidget {
  ...
  @override
  _ZefyrExpandingEditorState createState() => _ZefyrExpandingEditorState();
}
...
class _ZefyrExpandingEditorState extends State<ZefyrExpandingEditor> {
  ...
  @override
  void didUpdateWidget(ZefyrExpandingEditor oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    Widget editable = ZefyrExpandingEditableText(
