...
final kZefyrToolbarAttributeActions = <ZefyrToolbarAction, NotusAttributeKey>{
  ...
  ZefyrToolbarAction.alignLeft: NotusAttribute.block.alignLeft,
  ZefyrToolbarAction.alignRight: NotusAttribute.block.alignRight,
  ZefyrToolbarAction.alignCenter: NotusAttribute.block.alignCenter,
  ZefyrToolbarAction.alignJustify: NotusAttribute.block.alignJustify,
...
class _DefaultZefyrToolbarDelegate implements ZefyrToolbarDelegate {
  static const kDefaultButtonIcons = {
    ...
    ZefyrToolbarAction.alignLeft: Icons.format_align_left,
    ZefyrToolbarAction.alignRight: Icons.format_align_right,
    ZefyrToolbarAction.alignCenter: Icons.format_align_center,
    ZefyrToolbarAction.alignJustify: Icons.format_align_justify,
