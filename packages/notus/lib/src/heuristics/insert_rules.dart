...
class AutoExitBlockRule extends InsertRule {
  ...
  Delta? apply(Delta document, int index, Object data) {
    ...
    final targetAttributes = target.attributes!;
    final blockStyle = targetAttributes[NotusAttribute.block.key];
...
class PreserveBlockStyleOnInsertRule extends InsertRule {
  ...
  Delta? apply(Delta document, int index, Object data) {
    ...
    if (resetStyle != null) {
      assert(nextNewline.op != null && nextNewline.skippedLength != null);
